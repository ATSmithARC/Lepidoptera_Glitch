...
// Configure custom layer for the 3D model
const customLayer = {
  id: "3d-model",
  type: "custom",
  renderingMode: "3d",
  ...
  async function updateSearch(e) {
    if (e.type == "draw.delete") {
      ...
      if (geoJSONpoly.features.length > 0) {
        const selfIntersections = findSelfIntersects(geoJSONpoly.features[0].geometry.coordinates[0]);
